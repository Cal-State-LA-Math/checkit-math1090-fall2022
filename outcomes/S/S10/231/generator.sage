class Generator(BaseGenerator):
    def data(self):
        ...
        while(pvalue<0.03 or pvalue>0.07):
            ...
            if pvalue<.05:
                conclusion="reject"
            context="making renewable energy a central part of the Democratic party's goals for the 2024 election is NOT supported"
            if conclusion=="reject":
                context="making renewable energy a central part of the Democratic party's goals for the 2024 election is supported"
